...
public class AudioplayerultimatePlugin implements MethodCallHandler {

    private static final Logger LOGGER = Logger.getLogger(AudioplayerultimatePlugin.class.getCanonicalName());

    private static final String ID = "com.sidtube.audio/audioplayerultimate";
    ...
    public static void registerWith(final Registrar registrar) {
        ...
        channel.setMethodCallHandler(new AudioplayerultimatePlugin(registrar, channel));
    }

    private AudioplayerultimatePlugin(final Registrar registrar, final MethodChannel channel) {
